...
exports.constant = {
    devConstant: {
        ...
        [`${prefix}LOGOUT_URL`]: 'http://sso.cdk8s.com:9095/sso-client-management/logout?redirect_uri=http://localhost:8000',
    ...
    testConstant: {
        ...
        [`${prefix}LOGOUT_URL`]: 'http://sso.cdk8s.com/sso-client-management/logout?redirect_uri=http://sso.cdk8s.com/tkey-sso-client-management-frontend/TKeyClient',
